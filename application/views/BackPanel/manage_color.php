...
<head>
	...
	<title>Sparkling Beauty | Color</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Color</a></li>
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered nowrap">
                                                ...
                                                <tbody>
													<?php foreach($List as $lt){?>
														<tr>
															<td><?php echo $lt['tclr_title'];?></td>
															<td><div class="switch switch-success d-inline m-r-10">
																	<input type="checkbox" id="switch-s-1<?php echo $lt['tclr_id'];?>" value="<?php echo $lt['tclr_status'];?>" onchange="change_status(<?php echo $lt['tclr_id'];?>,this.value,this)" <?php if($lt['tclr_status']==1){ echo "checked";}?>>
																	<label for="switch-s-1<?php echo $lt['tclr_id'];?>" class="cr"></label>
																</div>
															</td>
															<td><button class="btn btn-success" onclick="show_modal(<?php echo $lt['tclr_id'];?>,

																								'<?php echo $lt['tclr_title'];?>'
...
function change_status(id,status,ele){
	...
	$.ajax({
		...
		url:"<?php echo base_url('BackPanel/Color/ChangeStatus');?>",
...
$("#cg_form").submit(function(e) {
	...
	if(isFormValid){
		...
		$.ajax({
			...
			url:"<?php echo base_url('BackPanel/Color/SaveColor');?>",
			...
			success:function(d){
...

				{
					...
					custom_notify('Color Added Successfully', "success");
							location.reload();
				...
				{
custom_notify('Color Updated Successfully', "success");

                    ...
                    <div class="col-md-9 push-md-3">
                        ...
                        <?php if (isset($Category)) { ?>
                            <div class="list-page-title">
                                <h2 class=""><?php echo $Category; ?> <small><?php echo sizeof($List); ?>
                                        Products</small></h2>
                            </div>
                        <?php } ?>
                        <!-- End Title -->
                        ...
                        <div class="row product-list-item">
                            ...
                            <?php if (!empty($List)) {
                                foreach ($List as $lt) { ?>
                                    <?php if (isset($Sizes[$lt['tp_id']][0])) {
                                        $price = $Sizes[$lt['tp_id']][0];
                                        $promotion_price = $Sizes[$lt['tp_id']][1];
                                    ...
                                    if ($lt['tp_gst_type'] == 2) {
                                        ...
                                        $promotion_price_gst = round($promotion_price * $lt['tp_gst_perce'] / 100);
                                        ...
                                        <div class="product-item">
                                            <div class="product-item-inner">
                                                <div class="product-img-wrap">
                                                    <?php if (isset($Images[$lt['tp_id']])) { ?>
                                                        <img src="<?php echo base_url('uploads/product/') . $Images[$lt['tp_id']]; ?>"
                                                             alt="">
                                                    <?php } else { ?>
                                                        <img src="<?php echo base_url('front_assets/img/noimage.png'); ?>"
                                                             alt="">
                                                    <?php } ?>
                                                </div>
                                                <div class="product-button">
                                                    <?php if (isset($lt['tp_size_category']) && $lt['tp_size_category'] > 0) { ?>
                                                        <a href="<?php echo base_url('shop/') . $lt['tp_slug']; ?>"
                                                           class="js_tooltip" data-mode="bottom"
                                                           data-tip="Select Option"><i
                                                                    class="fa fa-shopping-bag"></i></a>
                                                    <?php } else { ?>
                                                        <a href="javascript:void(0)"
                                                           onclick="add_to_cart(<?php echo $lt['tp_id'] ?>,'<?php echo $final_price; ?>','<?php echo $price; ?>','<?php echo $gst_amount ?>','<?php echo $lt['tp_gst_type'] ?>','<?php echo $lt['tp_gst_perce'] ?>')"
                                                           class="js_tooltip" data-mode="bottom" data-tip="Add To Cart"><i
                                                                    class="fa fa-shopping-bag"></i></a>
                                                    <?php } ?>
                                                    ...
                                                    ?>
                                                    <a href="javascript:void(0)" <?php echo $wish_link; ?>
                                                       class="js_tooltip" data-mode="bottom"
                                                       data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                                                    <?php $link = b2b($lt['tp_name'], $lt['tp_id'], $final_price); ?>
                                                    <a href="<?= $link; ?>" target="_blank" class="js_tooltip"
                                                       data-mode="top" data-tip="B2B Inquiry"><i
                                            ...
                                            <div class="product-detail">
                                                <p class="product-title"><a
                                                            href="<?php echo base_url('shop/') . $lt['tp_slug']; ?>">
                                                        <?php
                                                ...
                                                <h5 class="item-price">₹<?php echo $final_price; ?>
                                                    <span><?php echo $final_price < $final_promotion_price ? ('<s style="font-size: 15px !important;">' . $final_promotion_price . '</s>') : '' ?></span>
                                                </h5>
                                            </div>
                                        </div>
                                        <!-- End Product Item-->
                    ...
                    <div class="sidebar-container col-md-3 pull-md-9">
                        ...
                        <div class="widget-sidebar widget-price-range">
                            ...
                            <div class="price-range-amount">
                                <input id="price_range_min" name="price_range_min" data-min="1"
                                       placeholder="Min price" style="display: none;" type="text">
                                <input id="price_range_max" name="price_range_max"
                                       data-max="<?php echo isset($MaxPrice) ? $MaxPrice : 0; ?>"
                                       placeholder="Max price" style="display: none;" type="text">
                                <div id="price-range-from-to">
                                </div>
                            </div>
                            <button class="btn btn-xs btn-black pull-right" type="button" onclick="sort_change()">
                                Filter
                            </button>
                        </div>
                        ...
                        <div class="widget-sidebar widget-filter-color">
                            ...
                            <ul class="widget-content" style="height:250px;overflow-y:scroll">
                                ...
                                foreach ($color_data as $cd) {
                                    ?>
                                    <li><a href='javascript:void(0);'><label><input type="checkbox"
                                                                                    onchange='apply_filter(this,this.value)'
                                                                                    name="color_list[]"
                                                                                    value="<?php echo $cd['tclr_id']; ?>"
                                                                                    id="<?php echo $cd['tclr_id']; ?>"> <?php echo $cd['tclr_title']; ?>
                                            </label></a></li>
                                <?php } ?>
                            </ul>
                        </div>

                    ...
                    <div class="row">
						<?php 
							...
							if($isValidChecksum == "TRUE") {
								...
								if ($post_data["STATUS"] == "TXN_SUCCESS") {
									echo $pay_stt="<b>Transaction status is success</b>" . "<br/>";
									...
									echo $pay_stt="<b>Transaction status is failure</b>" . "<br/>";
								}
								...
								echo $pay_stt="<h2 class='text-center'>Checksum mismatched.</h2>";
								//Process transaction as suspicious.
							}
							$up_data1=array("o_type"=>1,"o_resp_msg"=>$post_data['RESPMSG'],"o_payment_note"=>$pay_stt,"o_paytm_id"=>$post_data['TXNID'],"o_pay_gateway"=>$post_data['GATEWAYNAME']);
							$this->db->where('o_id',$post_data["ORDERID"]);
					 ...
					 <div class="row">
							<div class="cart-btn-group">
								<a href="<?php echo base_url('my-orders');?>" class="submit btn btn-md btn-color">View Order History</a>
